    ...
    def schedule(self):
        ...
        while flag:
            ...
            if self.algoName == "sandpiper":
                newnodes ,eval_mig= self.algorithm(self.nodes,self.cpudict,self.memdict,self.algoName) #调度算法后生成新的node pod分配方案
    ...
    def getPodNodNum(self,t,flag=True):
        ...
        for podname,v in podeCpuMem.items():
            ...
            if t == 0 and self.algoName == "sxy":
                ...
                self.memdict[podname] = [2.24609375, 2.24609375, 2.24609375, 2.24609375, 2.24609375, 2.24609375, 2.24609375, 2.24609375, 2.24609375, 2.24609375]
